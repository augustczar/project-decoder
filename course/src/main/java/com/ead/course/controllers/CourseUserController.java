...
public class CourseUserController {
	...
	public ResponseEntity<Object> saveSubscriptionUserInCouse(@PathVariable(value = "courseId") UUID courseId,
		...
		//verificações state transer
		if(courseService.existesByCouseAndUser(courseId, subscriptionDto.getUserId())) {
		...
		courseService.saveSubscriptionUserInCourseEndSendNotification(courseModelOptional.get(), userModelOptional.get());
